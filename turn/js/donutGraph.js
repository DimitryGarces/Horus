            ...
            donut: {
                ...
                tooltip: {
                    ...
                    custom: function({ series, seriesIndex, dataPointIndex, w }) {
                        return `<div class="apexcharts-tooltip-custom">${rendimiento2}</div>`;
                    }
                }
            }
...
var chart = new ApexCharts(document.querySelector("#myDoughnutChart"), options);
chart.render();
